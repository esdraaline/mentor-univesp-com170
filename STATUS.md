...
- ~~Escrever no ponto de encontro do G4~~ **feito** em 13/08 às 20:25: ele listou os participantes (colega, colega, Fabricio e ele), abriu a partilha com o caso B e perguntou quem pegaria a representação desta quinzena. O Fabricio respondeu em 14/08. colega e colega não escreveram no fórum, mas constam como integrantes no template do grupo.
...
- **A prova de 22/09 conflita com o CAO, e isso precisa de autorização.** As três provas (COM100, LET110, SOC100) caem numa terça, das 17h55 às 22h05, no polo de Valparaíso. Desde 17/08 ele é oficial-aluno do CAO-II/26 (Mestrado Profissional em Ciências Policiais), presencial no CAES, Barra Funda, até agosto de 2027, com aula de segunda a quinta e **término às 18h00 nas terças**. São 570 km entre os dois lugares: não é conveniência, é impossibilidade.
  ...
  - **Dois pedidos, nesta ordem:** mesma data em polo da capital (a Univesp tem mais de 30 na cidade, e ele já estará lá) ou, não sendo possível, o próprio polo de Valparaíso numa **sexta do ciclo, 18/09 ou 25/09**, quando ele está na cidade.
  - **Vale pedir para o curso todo**, não só para setembro: o conflito se repete em cada bimestre até agosto de 2027.
  - **Prazo real:** protocolar no SAE até o início de setembro, senão os 10 dias úteis não cabem antes de 22/09. Escolhido em 15/08 falar primeiro com o polo; se não houver encaminhamento concreto até 19/08, abrir no SAE.
